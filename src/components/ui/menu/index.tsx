...
const menuStyle = tva({
  base: 'min-w-[100px] rounded-md bg-background-0 border border-outline-100 p-1 shadow-hard-5',
})

const menuItemStyle = tva({
  base: 'px-3 py-2 flex-row items-center data-[hover=true]:bg-app-gray-700 data-[active=true]:bg-app-gray-700 data-[focus=true]:bg-app-gray-700 data-[focus=true]:web:outline-none data-[focus=true]:web:outline-0 data-[disabled=true]:opacity-40 data-[disabled=true]:web:cursor-not-allowed data-[focus-visible=true]:web:outline-2 data-[focus-visible=true]:web:outline-primary-700 data-[focus-visible=true]:web:outline data-[focus-visible=true]:web:cursor-pointer data-[disabled=true]:data-[focus=true]:bg-transparent rounded-md',
})
...
const menuItemLabelStyle = tva({
  base: 'text-app-gray-100 font-normal font-body',
