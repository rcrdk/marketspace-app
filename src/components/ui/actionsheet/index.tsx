...
const actionsheetContentStyle = tva({
  base: 'items-center rounded-tl-3xl rounded-tr-3xl p-6 pt-2 pb-10 bg-background-0 web:pointer-events-auto web:select-none shadow-hard-5 border border-b-0 border-outline-100',
})
...
const actionsheetDragIndicatorWrapperStyle = tva({
  base: 'w-full py-1 mb-7 items-center',
})
