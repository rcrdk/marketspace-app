...
const actionsheetContentStyle = tva({
  base: 'items-center rounded-tl-3xl rounded-tr-3xl px-6 pb-8 pt-2 bg-background-0 web:pointer-events-auto web:select-none shadow-lg',
})

const actionsheetItemStyle = tva({
  base: 'w-full flex-row items-center p-3 rounded-sm data-[disabled=true]:opacity-40 data-[disabled=true]:web:pointer-events-auto data-[disabled=true]:web:cursor-not-allowed hover:bg-background-50 active:bg-app-gray-700 data-[focus=true]:bg-app-gray-700 web:data-[focus-visible=true]:bg-app-gray-700 data-[checked=true]:bg-app-gray-600 rounded-md',
})

const actionsheetItemTextStyle = tva({
  base: 'text-app-gray-100 font-normal font-karlaRegular tracking-md text-left mx-4',
  variants: {
    isTruncated: {
      true: '',
    },
...
const actionsheetDragIndicatorStyle = tva({
  base: 'w-16 h-1 bg-background-400 rounded-full mb-6',
})
