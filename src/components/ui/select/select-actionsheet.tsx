...
const actionsheetContentStyle = tva({
  base: 'items-center rounded-tl-3xl rounded-tr-3xl pt-2 pb-6 px-6 bg-background-0 web:pointer-events-auto web:select-none shadow-lg',
})

const actionsheetItemStyle = tva({
  base: 'w-full flex-row items-center px-3 py-2 mt-1 rounded-md data-[disabled=true]:opacity-40 data-[disabled=true]:web:pointer-events-auto data-[disabled=true]:web:cursor-not-allowed hover:bg-background-50 active:bg-app-gray-600 data-[focus=true]:bg-app-gray-600 web:data-[focus-visible=true]:bg-app-gray-600 data-[checked=true]:bg-app-gray-600',
})

const actionsheetItemTextStyle = tva({
  base: 'text-app-gray-100 font-normal font-body tracking-md text-left mx-4',
  variants: {
    isTruncated: {
      true: '',
    },
...
const actionsheetDragIndicatorStyle = tva({
  base: 'w-16 h-1 bg-app-gray-100 rounded-full',
})

const actionsheetDragIndicatorWrapperStyle = tva({
  base: 'w-full py-1 items-center mb-5',
})
